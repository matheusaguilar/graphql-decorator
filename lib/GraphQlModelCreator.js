...
function defineFK(target, key) {
    ...
    const resolver = (arg) => __awaiter(this, void 0, void 0, function* () {
        ...
        Object.keys(type).forEach((prop) => {
            if (Reflect.hasMetadata(Decorators_1.GRAPHQL_MODEL_PK, type, prop)) {
                console.log(arg[key]);
                console.log(Reflect.getMetadata(Decorators_1.GRAPHQL_MODEL_COLUMN, type, prop));
                // fkId in object
                if (fkId) {
                    type[prop] = fkId;
                    ...
                    type[prop] = arg[key][Reflect.getMetadata(Decorators_1.GRAPHQL_MODEL_COLUMN, type, prop)];
                }
            }
        });
        return type;
